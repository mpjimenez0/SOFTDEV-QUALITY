...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'region_id', 'city_municipal_id', 'barangay_id'], 'integer'],
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'account_status', 'first_name', 'middle_name', 'last_name', 'contact', 'role', 'external_type'], 'safe'],
        ];
    }
