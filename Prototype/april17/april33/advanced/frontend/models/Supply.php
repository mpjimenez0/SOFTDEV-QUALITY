...
class Supply extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id', 'barangay_id', 'city_municipal_id', 'province_id', 'region_id'], 'required'],
            [['id', 'barangay_id', 'city_municipal_id', 'province_id', 'region_id'], 'integer'],
            [['name', 'contact', 'contact_person'], 'string', 'max' => 45],
