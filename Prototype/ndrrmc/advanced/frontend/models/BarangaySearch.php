...
/**
 * BarangaySearch represents the model behind the search form about `frontend\models\Barangay`.
 */
class BarangaySearch extends Barangay
{
    ...
    {
        return [
            [['id', 'population', 'region_id', 'province_id', 'city_municipal_id'], 'integer'],
            [['Barangay_Name'], 'safe'],
        ];
    }
