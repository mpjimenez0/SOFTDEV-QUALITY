...
class RequestSearch extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            [['date_needed', 'date_requested', 'reason', 'receipient', 'beneficiary', 'priority', 'status', 'vehicle_plate_number', 'vehicle_type', 'volunteer_type', 'supply_type'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'volunteer_type' => $this->volunteer_type,
